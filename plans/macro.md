...
| Taper begins | 2027-05-09 | Planned |
...
- Run: 2x (1 easy long, 1 structured ≤1h)
- Bike: 2x (1 long Saturday, 1 mid-week moderate)
- Swim: 0x until course complete → then 1–2x
...
### Phase 2 — Build (2026-W40 → 2026-W52)
**Dates**: 2026-09-28 → 2026-12-27 (~13 weeks)
**Focus**: Progressive overload. Increase swim volume and confidence. Introduce tempo and threshold work in bike and run. First brick sessions.

Weekly session targets:
- Run: 2x (1 long, 1 tempo or intervals)
- Bike: 2x (1 long Saturday, 1 mid-week with intensity)
- Swim: 2x (building from technique to endurance)
- Strength: 2x
...
### Phase 3 — Peak (2027-W01 → 2027-W17)
**Dates**: 2026-12-28 → 2027-05-01 (~17 weeks)
**Focus**: Race-specific fitness. Longest sessions of the cycle. Regular brick sessions. Simulate race conditions. Run off the bike.

Weekly session targets:
- Run: 2x (1 long, 1 race-pace)
- Bike: 2x (1 long ≥ race distance, 1 brick)
- Swim: 2x (race distance simulation)
- Strength: 2x (reduce to 1x in final 4 weeks)
- Brick: 1x biweekly → 1x weekly in final 6 weeks

Weekly volume targets:
- Peak weeks: ~11–13h/week
...
**Dates**: 2027-05-04 → 2027-05-23 (~3 weeks)
